...
import style from './ResponsiveContact.module.css'
    ...
    return (
      <div className={style.contact}>
        <div className={style.textContainer}>
          <h1 className={style.textHeader}>{header}</h1><hr />
          ...
          <Container>
           ...
           <ul className={style.contactList}>
            <li>{emailMe}<span className={style.email}>bautista.zitelli11@gmail.com</span></li>    
          </ul> 
        </div>
