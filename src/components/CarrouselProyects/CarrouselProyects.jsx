...
function CarrouselProyects() {
  const { language } = useLanguage();

  const header = language === 'es' ? 'Mis proyectos:' : 'My proyects'
  const slideText = language === 'es' ? 'Desliza para ver!' : 'Slide to see!'
  const technologies = language === 'es' ? 'Tecnologias utilizadas:' : 'Technologies used:'
  const deployedProyect = language === 'es' ? 'Deploy del proyecto' : `Go to the project's deployment`
    ...
    <Carousel className={style.carrouselContainer}>
      ...
      <Card className={style.proyectCard}>
            <Card.Body>
              <Card.Title className={style.proyectTitle}>
              {language === 'es' 
                ? 'Landing page para un local comercial:'
                : 'Commercial local landing page'}</Card.Title>
              <Card.Text className={style.proyectDescription}>
                {language === 'es' 
              ...
              <Button href='https://github.com/Bautizitelli/Bautizitelli.github.io' target="_blank" rel="noopener noreferrer" variant="dark">Ir al repositorio</Button>
              </div>
            </Card.Body>
          </Card>
            <div className={`d-flex justify-content-center ${style.buttonContainer}`}>
...
export default CarrouselProyects;